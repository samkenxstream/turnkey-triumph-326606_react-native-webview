...
import { UIManager as NotTypedUIManager, View, StyleSheet, Image, findNodeHandle, } from 'react-native';
...
var version = require('react-native/Libraries/Core/ReactNativeVersion').version;
...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.RnwVersionSupportsWebView2 = (version.major > 1 || version.minor >= 68);
        _this.RCTWebViewString = (_this.RnwVersionSupportsWebView2 && _this.props.useWebView2) ? 'RCTWebView2' : 'RCTWebView';
        _this.goForward = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), UIManager.getViewManagerConfig(_this.RCTWebViewString).Commands.goForward, undefined);
        };
        _this.goBack = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), UIManager.getViewManagerConfig(_this.RCTWebViewString).Commands.goBack, undefined);
        };
        _this.reload = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), UIManager.getViewManagerConfig(_this.RCTWebViewString).Commands.reload, undefined);
        };
        _this.injectJavaScript = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), UIManager.getViewManagerConfig(_this.RCTWebViewString).Commands.injectJavaScript, [data]);
        };
        _this.postMessage = function (data) {
            var message = _this.getInjectableJSMessage(data);
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), UIManager.getViewManagerConfig(_this.RCTWebViewString).Commands.injectJavaScript, [message]);
        };
    ...
    WebView.prototype.render = function () {
        var _a = this.props, _b = _a.nativeConfig, nativeConfig = _b === void 0 ? {} : _b, onMessage = _a.onMessage, onShouldStartLoadWithRequestProp = _a.onShouldStartLoadWithRequest, originWhitelist = _a.originWhitelist, renderError = _a.renderError, renderLoading = _a.renderLoading, style = _a.style, containerStyle = _a.containerStyle, useWebView2 = _a.useWebView2, otherProps = __rest(_a, ["nativeConfig", "onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "style", "containerStyle", "useWebView2"]);
        var otherView = null;
        ...
        var NativeWebView = (this.RnwVersionSupportsWebView2 && this.props.useWebView2) ? RCTWebView2 : RCTWebView;
...
export function releaseWebView(_webViewKey) {
    // no-op
}
